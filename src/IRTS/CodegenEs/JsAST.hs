...
jsAst2Text (JsIf cond conseq (Just alt@(JsIf _ _ _))) =
  T.concat
    [ "if("
    , jsAst2Text cond
    , ") {\n"
...
jsAst2Text (JsIf cond conseq (Just alt)) =
  T.concat
    [ "if("
    , jsAst2Text cond
    , ") {\n"
...
jsAst2Text (JsIf cond conseq Nothing) =
...
jsAst2Text (JsError t) = T.concat ["throw new Error(  ", jsAst2Text t, ")"]
